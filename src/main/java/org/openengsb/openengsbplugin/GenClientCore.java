 ...
 * @aggregator true
 */
public class GenClientCore extends MavenExecutorMojo {
    ...
    private static final String ARCHETYPE_ARTIFACTID = "org.openengsb.tooling.archetypes.clientproject.core";
    ...
    protected void postExec() throws MojoExecutionException {
        Tools.renameArtifactFolderAndUpdateParentPom(artifactId, "core");
